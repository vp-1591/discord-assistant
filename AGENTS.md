## Goal
This project's goal is to create a discord bot that can answer questions about server history, interpreting history as absolute truth for entertainment purposes.
## Architecture
